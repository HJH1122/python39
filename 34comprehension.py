...
# for 다중 if 축약문
# [ 표현식 if 조건 for 항목 in 반복가능개체 ]
q = [ 'even' if i % 2 == 0 else 'odd'
      for i in range(1, 100+1) ]
print(q)


# ex) 구구단 중에서 7,8단의 결과값을 리스트에 저장
# [ 7,14,21,28..... ,8,16,24.... ,72 ]
# 7 x 1 = 7
# 7 x 2 = 14
# ...
# 7 x 9 = 63
...
# 딕셔너리 for 축약문
# { 키값표현식 for k, v in zip(반복가능개체1, 반복가능개채2) }
...
#    for k, v in zip(반복가능개체1, 반복가능개채2) }
